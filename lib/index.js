...
var PhotoViewer = function (_Component) {
  ...
  function PhotoViewer(props) {
    ...
    _this.bindEvent = function (remove) {
      ...
      mouseScrollArea = _this.imgViewer;
      mouseScrollArea[funcName]('mousewheel', _this.handleMouseScroll, false);
      mouseScrollArea[funcName]('click', _this.handleMouseUp, false);
      mouseScrollArea[funcName]('mousemove', _this.handleMouseMove, false);
      mouseScrollArea[funcName]('mousedown', _this.handleMouseDown, false);
      mouseScrollArea[funcName]('mouseleave', _this.handleMouseLeave, false);
    ...
    _this.handleMouseMove = function (e) {
      ...
      if (_this.state.isMouseDown) {
        if (_this.state.mouseX !== null && _this.state.mouseY !== null) {
          dx = e.clientX - _this.state.mouseX;
          dy = e.clientY - _this.state.mouseY;
        }

        var _this$getImgWidthHeig = _this.getImgWidthHeight(),
        ...
        var isRotate = Math.abs(_this.state.rotate / 90 % 2) === 1; //rotate change move left and top
        var lx = Math.abs((_this.state.scaleX - 1) * _this.state.width / 2);
        var ly = Math.abs((_this.state.scaleY - 1) * _this.state.height / 2);
        if (isRotate) {
          lx = Math.abs((width - _this.state.scaleY * _this.state.height) / 2);
          ly = Math.abs((_this.state.scaleX * _this.state.width - height) / 2);
        }
        var mTop = _this.state.top + dy;
        var mLeft = _this.state.left + dx;
        if (!(-ly < mTop && mTop < ly)) {
          mTop = mTop < 0 ? -ly : ly;
        }
    ...
    _this.handleMouseScroll = function (e) {
      ...
      if (direct !== 0) {
        ...
        var y = e.clientY;
        if (_this.imgViewer) {
          var containerRect = _this.imgViewer.getBoundingClientRect();
          x -= containerRect.left;
          y -= containerRect.top;
        }
        _this.handleZoom(x, y, direct, _this.state.zoomSpeed);
      }
    };
    ...
    _this.handleResize = function () {
      var _this$getImgWidthHeig3 = _this.getImgWidthHeight(),
    ...
    _this.handleZoom = function (targetX, targetY, direct, scale) {
      ...
      if (_this.state.width === 0) {
        var _this$getImgWidthHeig5 = _this.getImgWidthHeight(),
            _this$getImgWidthHeig6 = _slicedToArray(_this$getImgWidthHeig5, 2),
            imgWidth = _this$getImgWidthHeig6[0],
            imgHeight = _this$getImgWidthHeig6[1];
    ...
    _this.handleChangeImg = function (activeIndex) {
      _this.setState({ activeIndex: activeIndex });
      _this.handleResize();
    };

    _this.doAction = function (type) {
      if (!_this.props.photos || _this.props.photos.length === 0) return;
      switch (type) {
        case _constant.ActionType.zoomIn:
          var imgCenterXY = _this.getImageCenterXY();
          _this.handleZoom(imgCenterXY.x, imgCenterXY.y, 1, _this.state.zoomSpeed);
          break;
        case _constant.ActionType.zoomOut:
          var imgCenterXY2 = _this.getImageCenterXY();
          _this.handleZoom(imgCenterXY2.x, imgCenterXY2.y, -1, _this.state.zoomSpeed);
          break;
        case _constant.ActionType.rotateLeft:
          _this.handleRotate();
          break;
        case _constant.ActionType.rotateRight:
          _this.handleRotate(true);
          break;
        case _constant.ActionType.prev:
          _this.handleChangeImg(_this.state.activeIndex - 1);
          break;
        case _constant.ActionType.next:
          _this.handleChangeImg(_this.state.activeIndex + 1);
          break;
        case _constant.ActionType.reset:
          _this.handleResize();
          break;
        default:
          break;
  ...
  _createClass(PhotoViewer, [{
    ...
    value: function componentDidMount() {
      ...
      var _getImgWidthHeight = this.getImgWidthHeight(),
    ...
    value: function getImgWidthHeight() {
      var width = this.imgViewer.getBoundingClientRect().width;
      var height = this.imgViewer.getBoundingClientRect().height;
      return [width, height];
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _jsx('div', {
        className: 'component-poi-fe-imgviewer'
      }, void 0, _react2.default.createElement(
        'div',
        { className: 'current-img', style: containerStyle, ref: function ref(imgViewer) {
            _this2.imgViewer = imgViewer;
          } },
        _jsx('ul', {
          className: 'viewer-toolbar'
        }, void 0, _constant.actionList && _constant.actionList.map(function (item, index) {
          return _jsx('li', {
            onClick: function onClick() {
              return _this2.doAction(item.action);
            }
          }, index, _jsx('i', {
            className: 'viewer-icon viewer-icon-' + item.type
          }));
        })),
        activeIndex !== 0 ? _jsx('div', {
          onClick: function onClick() {
            return _this2.doAction(3);
          },
          className: 'pre-icon'
        }, void 0, _ref) : null,
        activeIndex !== photos.length - 1 ? _jsx('div', {
          onClick: function onClick() {
            return _this2.doAction(4);
          },
          className: 'next-icon'
        }, void 0, _ref2) : null,
        photos && photos.length ? _jsx('img', {
          className: 'big-img',
          src: photos[activeIndex || 0].url,
          style: imgStyle
        }) : null
      ), _jsx('div', {
      ...
      }, void 0, photos && photos.map(function (item, i) {
        return _jsx('img', {
          className: (activeIndex || 0) === i ? 'bottom-imglist-current' : '',
          src: item.url,
          onClick: function onClick() {
            return _this2.handleChangeImg(i);
          }
        }, item.url);
      }))));
    }
...
var actionList = [{ type: 'zoomIn', action: 1 }, { type: 'zoomOut', action: 2 }, { type: 'rotateLeft', action: 5 }, { type: 'rotateRight', action: 6 }, { type: 'reset', action: 7 }];

var nextPre = [{ type: 'prev', action: 3 }, { type: 'next', action: 4 }];
